...
os.environ["MONGODB_URL"] = "mongodb://127.0.0.1:27017"  # Use local MongoDB without auth for tests
...
async def setup_test_db():
    ...
    try:
        ...
        # Skip MongoDB tests if not available
        print(f"Warning: MongoDB not available for tests: {e}")
        return
    ...
    try:
        ...
        print(f"Warning: Redis not available for tests: {e}")
        return
    ...
    try:
        ...
        pass  # Databases might not be available
